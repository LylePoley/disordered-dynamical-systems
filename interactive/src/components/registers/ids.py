""" Variable ids for all app components."""
...
interaction_standard_deviation_input = 'standard-deviation-input'
number_of_agents_input = 'number-of-agents-input'
time_final_input = 'time-final-input'
