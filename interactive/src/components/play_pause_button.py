...
pause_button = dbc.Button('Pause', id=ids.pause_button, color='primary', style=style.SIDEBAR_BUTTON)
play_button = dbc.Button('Play', id=ids.play_button, color='primary', style=style.SIDEBAR_BUTTON)
