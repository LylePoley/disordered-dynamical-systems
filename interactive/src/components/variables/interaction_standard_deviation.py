...
interaction_standard_deviation_tooltip = dbc.Tooltip(
    [dcc.Markdown(r"""$\frac{\sigma^2}{N}$ is the variance of the distribution from which the elements of $\underline{\underline{\alpha}}$ are generated. For large enough $N$, we have""", mathjax=True),
     dcc.Markdown(r"""$$\sigma^2 = \frac{1}{N}\sum_{ij}\left(\alpha_{ij} - \frac{\mu}{N}\right)^2.$$""", mathjax=True)],
