...
def integrate(
        ...
        y0: float, **kwargs) -> tuple[np.ndarray, np.ndarray]:
    """
    Calls scipys solve_ivp function to integrate function over a time span.
    Values which are set automatically are atol = 1e-8, rtol = 1e-5, and
    t_eval is also computed automatically.
    ...
    Returns:
        tuple[np.ndarray, np.ndarray]: The time points and the values of the
        function at those time points.
    """
